...
static ap_module_t g_ApAi2;
static ap_module_t g_ApAuction;
static ap_module_t g_ApBase;
static ap_module_t g_ApBillInfo;
static ap_module_t g_ApCashMall;
static ap_module_t g_ApCharacter;
static ap_module_t g_ApChat;
static ap_module_t g_ApConfig;
static ap_module_t g_ApPacket;
static ap_module_t g_ApTick;
static ap_module_t g_ApRandom;
static ap_module_t g_ApStartupEncryption;
static ap_module_t g_ApSystemMessage;
static ap_module_t g_ApFactors;
static ap_module_t g_ApObject;
static ap_module_t g_ApDungeonWnd;
static ap_module_t g_ApPluginBossSpawn;
static ap_module_t g_ApSpawn;
static ap_module_t g_ApSkill;
static ap_module_t g_ApItem;
