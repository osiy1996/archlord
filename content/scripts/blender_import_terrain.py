...
def import_terrain(filepath, texturedir):
    # Opening JSON file
    f = open(filepath)
    ...
    splitindex = 0
    collection = bpy.data.collections.new("Imported Terrain")
    ...
    for i, split in data['splits'].items():
        ...
        mesh = bpy.data.meshes.new(name = "TerrainMesh" + str(splitindex))
        mesh.from_pydata(vertices, edges, faces)
        
        # Create a mesh object
        obj = bpy.data.objects.new("TerrainObject" + str(splitindex), mesh)
        splitindex += 1
        ...
        # Create the material
        mat = bpy.data.materials.new(name = "TerrinMaterial" + str(splitindex))
        mat.use_nodes = True
...
# Usage:
#import_terrain("D:/ArchLord_Main/archlord-editor/content/exports/Terrain157246.json", 
#    "D:/ArchLord_Main/archlord-editor/content/exports/textures")
